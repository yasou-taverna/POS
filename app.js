    ...
    addToOrder(recipe) {
        ...
        getInventoryItemName(item) {
            ...
            const labels = {
                ...
                'Ground Beef': 'בשר בקר טחון',
                'Burger Buns': 'לחמניות המבורגר'
            };
        ...
        getInventorySupplierLabel(supplier) {
            const labels = {
                'Local Bakery': 'מאפייה מקומית',
                'Italian Imports': 'יבוא איטלקי',
                'Dairy Fresh': 'מחלבת פרש',
                'Premium Meats': 'בשרים פרימיום'
            };
